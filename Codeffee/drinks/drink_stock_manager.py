...
class DrinkStockManager:
    def __init__(self, filename="drinks/drink_stock.json"):
    ...
    def add_new_product(self):
        category = input("\033[36mEnter category:\n>> \033[0m").title().strip()
        product_name = input("\033[35mEnter drink name add to category:\n>> \033[0m").title().strip()

        while True:
            try:
                amount = float(input("\033[36mEnter price of drink: \n>> \033[0m"))
                break
            except ValueError:
    ...
    def remove_product(self):
        category = input("\033[36mEnter category:\n>> \033[0m").title().strip()
        product_name = input("\033[35mEnter drink name to remove:\n>> \033[0m").title().strip()  
    ...
    def update_price(self):
        category = input("\033[36mEnter category:\n>> \033[0m").title().strip()
        product_name = input("\033[35mEnter drink name: \n>> \033[0m").title().strip()

        while True:
            try:
                new_price = float(input("\033[36mEnter price of drink: \n>> \033[0m"))
                break
            except ValueError:
    ...
    def save_to_file(self, filename="drinks/drink_stock.json"):
